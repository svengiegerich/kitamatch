...
<div class="row justify-content-center">
  <div class="col-md-8">
    <h4><span class="badge badge-light badge-big">{{count($matches)}}</span> Zuordnungen nach <span class="badge badge-light">{{$data['countRounds']}}</span> Koordinierungsrunde</h4>
  </div>
</div>
