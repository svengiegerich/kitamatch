...
<div class="panel-body">
    ...
    <h3>Preferences of Program <strong><?php foreach ($preferences as $preference) { echo $preference->id_from; break; } ?></strong></h3>
    
    <!-- New Preference Form -->
    <form action="/preference/program/<?php foreach ($preferences as $preference) { echo $preference->id_from; break; } ?>" method="POST" class="form-horizontal">
        {{ csrf_field() }}
