...
<div class="row justify-content-center">
    ...
    <div class="col-md-10 my-3 p-3 bg-white rounded box-shadow">
        ...
        <h5><span class="badge badge-success">Erfolgreiches Angebot</span></h5>
        <h5><span class="badge badge-info">Gehaltenes Angbot</span></h5>
        <h5><span class="badge badge-light">Bewerber</span></h5>
        <br><br>
        </div>
            <?php $i = 1; ?>
            @if (count($matches) > 0)
                              ...
                              <td>{{$i}}</td>
                                ...
                                <td>
                                  <form action="/preference/program/undo/{{$program->pid}}" id="delete_{{$preference->prid}}" method="POST">
                                    ...
                                    <button form="delete_{{$preference->prid}}" class="ui-icon ui-icon-closethick" style="border:none;"></button>
                                  </form>
                                </td>
                            </tr>
                            <?php $i = $i + 1; ?>
