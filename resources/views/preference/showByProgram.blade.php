...
<div class="panel-body">
    ...
    <h3>Preferences of Program <strong><?php $pids = (Array)$preferences; print($pids); ?></strong></h3>
    
    <!-- New Preference Form -->
    <form action="/preference/program/<?php print($pids); ?>" method="POST" class="form-horizontal">
        {{ csrf_field() }}
